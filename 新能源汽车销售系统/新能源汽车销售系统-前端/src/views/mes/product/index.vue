    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="产品">
          <el-select v-model="form.materialId" placeholder="请选择产品ID">
            <el-option
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getProduct(id).then(response => {
        ...
        this.open = true;
        this.title = "修改产品建模";
        this.$set(this.form, 'materialId', response.data.materialId);
      });
    },
    /** 提交按钮 */
    submitForm() {
